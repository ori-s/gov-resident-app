(function ()
{
    ...
    function ProductsController($state, Products)
    {
        ...
        vm.dtOptions = {
            ...
            {
                var api = this.api(),
                    searchBox = angular.element('body').find('#message-groups-products-search');
        ...
        {
            $state.go('app.message-groups.products.add');
        }
        ...
        {
            $state.go('app.message-groups.products.detail', {id: id});
        }
    }
})();