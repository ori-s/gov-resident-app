(function ()
{
    ...
    function msMaterialColorPickerController($scope, $mdColorPalette, $mdMenu, fuseGenerator)
    {
        ...
        {
            $scope.$buttonCaption = vm.buttonCaption;
        ...
        function updateModel()
        {
            if ( vm.msModelType === 'class' )
            {
                var oldValue = vm.modelCtrl.$viewValue || "";
                if (oldValue != vm.selectedColor.class){
    ...
    function msMaterialColorPicker()
    {
        return {
            ...
            link       : function (scope, element, attrs, controllers, transclude)
            {
                ...
                ctrl.buttonCaption = scope.buttonCaption || 'Select a color';
